...
export default function EditLandlordAccessPage() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Manage landlord access</CardTitle>
        <CardDescription>
          Update user details or revoke portal access.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                ...
                <FormItem className="flex flex-row items-start gap-3 rounded-lg border p-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      When checked, the landlord is immediately blocked from the
                      portal. Unchecking reactivates access.
                    </p>
                  </div>
                </FormItem>
              )}
      ...
      <CardFooter>
        <p className="text-xs text-muted-foreground">
          Revoked records remain for audit purposes. Reactivate access at any
          time.
        </p>
      </CardFooter>
    </Card>
